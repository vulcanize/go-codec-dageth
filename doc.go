...
(https://github.com/ipld/ipld/tree/master/specs/codecs/dag-eth) for
...
they should have the non-optional fields shown in the DAG-ETH [schemas](https://github.com/ipld/ipld/tree/master/specs/codecs/dag-eth):
